...
class Party:
    ...
    def verify_shares(self, parties, encrypted_share_pairs, pi_share):
        ...
        for i in range(0, self.n):
            ...
            divider = pow(self.encrypted_share_pairs[i], d, self.q) #! This should be multiplied with inverse probably instead of dividing
    ...
    def receive_decrypted_share_and_proof(self, decrypted_share_pair, share_proof):
        ...
        Using the proof, the share is verified and accepted if the proof verification is successful
        ...
        """
        if self.is_verified_share(decrypted_share_pair, share_proof):
