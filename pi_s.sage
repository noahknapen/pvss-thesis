...
os.system('sage --preparse general_ed25519_pvss_functions.sage')
os.system('mv general_ed25519_pvss_functions.sage.py general_ed25519_pvss_functions.py')

from general_ed25519_pvss_functions import *
